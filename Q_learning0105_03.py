...
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / 'outputs_q_learning0105_03'
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Jednoduchsia verzia Q-learning experimentu s vybranymi reward variantmi.')
