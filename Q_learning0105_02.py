...
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / 'outputs_q_learning0105_02'
...
def eval_agent(env: CityLearnEnv, act_fn) -> PolicyRun:
    ...
    base_env = env.unwrapped# objekt, ktorý už vie spočítať oficiálne hodnotiace metriky
    buildings = base_env.buildings
    kpis = base_env.evaluate() #spočíta finálne metriky za celú simuláciu - slúži len na vyhodnotenie už odbehnutej simulácie
