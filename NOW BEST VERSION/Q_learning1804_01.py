...
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / 'outputs_q_learning1804_01'
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description='Q-learning so všetkými 3 akciami: porovnanie 2 reward funkcií voči fixnej stratégii.'
    )
