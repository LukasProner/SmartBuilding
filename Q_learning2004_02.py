...
DEFAULT_SEEDS = [7]
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / 'outputs_q_learning2004_02'
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description='Q-learning: povodna verzia s reward konfiguraciami, aktualne spustena len pre Weather reward s jednym seedom na citylearn_challenge_2023_phase_1.'
    )
